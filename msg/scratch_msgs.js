...
Blockly.ScratchMsgs.locales["es"] = 
{
    ...
    "CONTROL_STARTASCLONE": "cuando comienzo como clon",
    "CONTROL_CREATECLONEOF": "crear clon de %1",
    "CONTROL_CREATECLONEOF_MYSELF": "de mí mismo",
    "CONTROL_DELETETHISCLONE": "eliminar este clon",
    "CONTROL_COUNTER": "contador",
    "CONTROL_INCRCOUNTER": "incrementar contador",
    "CONTROL_CLEARCOUNTER": "reiniciar contador",
    "CONTROL_ALLATONCE": "todo a la vez",
    ...
    "DATA_DELETEALLOFLIST": "eliminar todo de %1",
    "DATA_INSERTATLIST": "insertar %1 en %2 de %3",
    "DATA_REPLACEITEMOFLIST": "reemplazar ítem %1 de %2 con %3",
    "DATA_ITEMOFLIST": "ítem %1 de %2",
    "DATA_ITEMNUMOFLIST": "ítem # de %1 en %2",
    ...
    "EVENT_WHENARDUINOBEGIN": "cuando Arduino comience",
    "EVENT_WHENMICROPYTHONBEGIN": "cuando MicroPython comience",
    "EVENT_WHENMICROBITBEGIN": "cuando Microbit comience",
    "EVENT_WHENMICROBITBUTTONPRESSED": "cuando el botón %1 sea presionado",
    "EVENT_WHENMICROBITPINBEINGTOUCHED": "cuando el pin %1 sea tocado",
    "EVENT_WHENMICROBITGESTURE": "cuando el gesto sea %1",
    "EVENT_WHENFLAGCLICKED": "cuando se haga clic en %1",
    "EVENT_WHENTHISSPRITECLICKED": "cuando se haga clic en este sprite",
    "EVENT_WHENSTAGECLICKED": "cuando se haga clic en el escenario",
    "EVENT_WHENTOUCHINGOBJECT": "cuando este sprite toque a %1",
    ...
    "EVENT_WHENGREATERTHAN_LOUDNESS": "volumen",
    "EVENT_BROADCAST": "enviar mensaje %1",
    "EVENT_BROADCASTANDWAIT": "enviar mensaje %1 y esperar",
    "EVENT_WHENKEYPRESSED": "cuando la tecla %1 sea presionada",
    "EVENT_WHENMICROBITGESTURE_SHAKEN": "sacudido",
    "EVENT_WHENMICROBITGESTURE_TILTEDUPWARD": "inclinación hacia arriba",
    "EVENT_WHENMICROBITGESTURE_TILTEDDOWNWARD": "inclinación hacia abajo",
    "EVENT_WHENMICROBITGESTURE_TILTEDDLEFTWARD": "inclinación hacia la izquierda",
    "EVENT_WHENMICROBITGESTURE_TILTEDDRIGHTWARD": "inclinación hacia la derecha",
    "EVENT_WHENMICROBITGESTURE_FACEUP": "cara arriba",
    "EVENT_WHENMICROBITGESTURE_FACEDOWN": "cara abajo",
    "EVENT_WHENMICROBITGESTURE_FREEFALL": "caída libre",
    ...
    "EVENT_WHENKEYPRESSED_ANY": "cualquier tecla",
    ...
    "LOOKS_SHOW": "mostrar",
    "LOOKS_HIDE": "ocultar",
    "LOOKS_HIDEALLSPRITES": "ocultar todos los sprites",
    "LOOKS_EFFECT_COLOR": "color",
    ...
    "LOOKS_CLEARGRAPHICEFFECTS": "eliminar efectos gráficos",
    ...
    "MOTION_GLIDESECSTOXY": "deslizar %1 segs a x: %2 y: %3",
    "MOTION_GLIDETO": "deslizar %1 segs a %2",
    "MOTION_GLIDETO_POINTER": "puntero del ratón",
    "MOTION_GLIDETO_RANDOM": "posición aleatoria",
    "MOTION_CHANGEXBY": "cambiar x por %1",
    "MOTION_SETX": "fijar x en %1",
    "MOTION_CHANGEYBY": "cambiar y por %1",
    "MOTION_SETY": "fijar y en %1",
    "MOTION_IFONEDGEBOUNCE": "si está en el borde, rebotar",
    ...
    "MOTION_SETROTATIONSTYLE_ALLAROUND": "todo alrededor",
    ...
    "MOTION_SCROLLUP": "desplazar hacia arriba %1",
    ...
    "MOTION_XSCROLL": "desplazamiento x",
    "MOTION_YSCROLL": "desplazamiento y",
    "MOTION_STAGE_SELECTED": "Escenario seleccionado: no hay bloques de movimiento",
    "OPERATORS_ADD": "%1 + %2",
    "OPERATORS_SUBTRACT": "%1 - %2",
    "OPERATORS_MULTIPLY": "%1 * %2",
    "OPERATORS_DIVIDE": "%1 / %2",
    "OPERATORS_RANDOM": "elegir al azar %1 a %2",
    "OPERATORS_GT": "%1 > %2",
    "OPERATORS_LT": "%1 < %2",
    "OPERATORS_EQUALS": "%1 = %2",
    "OPERATORS_AND": "%1 y %2",
    ...
    "SENSING_TOUCHINGCOLOR": "tocando color %1?",
    "SENSING_COLORISTOUCHINGCOLOR": "¿el color %1 está tocando %2?",
    ...
    "SENSING_MOUSEX": "ratón x",
    "SENSING_MOUSEY": "ratón y",
    "SENSING_SETDRAGMODE": "configurar modo de arrastre %1",
    "SENSING_SETDRAGMODE_DRAGGABLE": "arrastrable",
    "SENSING_SETDRAGMODE_NOTDRAGGABLE": "no arrastrable",
    "SENSING_LOUDNESS": "volumen",
    "SENSING_LOUD": "fuerte?",
    "SENSING_TIMER": "temporizador",
    "SENSING_RESETTIMER": "reiniciar temporizador",
    "SENSING_OF": "%1 de %2",
    ...
    "SOUND_PLAYUNTILDONE": "reproducir sonido %1 hasta terminar",
    "SOUND_STOPALLSOUNDS": "detener todos los sonidos",
    "SOUND_SETEFFECTO": "configurar efecto %1 a %2",
    "SOUND_CHANGEEFFECTBY": "cambiar efecto %1 por %2",
    "SOUND_CLEAREFFECTS": "eliminar efectos de sonido",
    "SOUND_EFFECTS_PITCH": "tono",
    "SOUND_EFFECTS_PAN": "pan izquierda/derecha",
    "SOUND_CHANGEVOLUMEBY": "cambiar volumen por %1",
    "SOUND_SETVOLUMETO": "configurar volumen a %1%",
    ...
    "CANNOT_DELETE_VARIABLE_PROCEDURE": "No se puede eliminar la variable \"%1\" porque forma parte de la definición de la función \"%2\"",
    ...
    "PROCEDURE_USED": "Para eliminar una definición de bloque, primero elimina todos los usos del bloque",
    "NEW_LIST": "Crear una Lista",
    "NEW_LIST_TITLE": "Nombre de la nueva lista:",
